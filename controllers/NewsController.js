...
import { newsSchema } from "../validations/newsValidator.js";
...
/**************    READ NEWS DATA  ********************/ 
  ...
  static async index(req, res) {
    ...
    return res.json({status: 200, message:"Showing all news", news:newsTransform, metadata:{
      totalPages,
      currentPage:page,
      currentLimit:limit,
    }})
  ...
  static async show(req, res) {
    try {
      ...
      return res
        .status(500)
        .json({ message: "Somrthing went wrong in show News.please try again." });
    }
  }
  ...
  static async store(req, res) {
    try {
      ...
      // Image uploading after checking for any errors
...
static async update(req, res) {
    try {
      ...
      // To restrict UnAuthorized Update Access 
