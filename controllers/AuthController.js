...
class AuthController {
    static async register(req, res) {
        try {
            ...
            return res.json({ status: 200, message: "User created sucessfully", user });
    ...
    static async login(req, res) {
        try {
            ...
            if (findUser) {
                ...
                return res.json({ message: "Logged in",access_toke:`Bearer ${token}`} )
            }
  ...
  static async sendTestEmail(req, res) {
    ...
    //   await sendEmail(payload.toEmail, "Second email", payload.body);
